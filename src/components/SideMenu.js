...
const SideMenu = props => {
  ...
  return (
    <SideMenuContainer ref={node} className={`${open ? "open" : "closed"}`}>
      <div>
        <NavBarLink
          active={activeItem === "thegame"}
          onClick={() => handleLinkClick("thegame")}
        >
          המשחק
        </NavBarLink>
        <NavBarLink
          active={activeItem === "whoweare"}
        ...
        <NavBarLink
          ...
          onClick={() => handleLinkClick("playnow")}
        >
          {" "}
          שחקו עכשיו
        </NavBarLink>
        <NavBarLink
          active={activeItem === "qanda"}
          onClick={() => handleLinkClick("qanda")}
        >
          {" "}
          שאלות ותשובות
        </NavBarLink>
